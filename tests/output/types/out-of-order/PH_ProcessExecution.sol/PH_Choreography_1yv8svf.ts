...
export interface PH_Choreography_1yv8svfInterface extends Interface {
  getFunction(
...
export interface PH_Choreography_1yv8svf extends BaseContract {
  connect(runner?: ContractRunner | null): PH_Choreography_1yv8svf;
  waitForDeployment(): Promise<this>;

  interface: PH_Choreography_1yv8svfInterface;
