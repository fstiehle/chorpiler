...
export interface PH_0Interface extends Interface {
  getFunction(
...
export interface PH_0 extends BaseContract {
  connect(runner?: ContractRunner | null): PH_0;
  waitForDeployment(): Promise<this>;

  interface: PH_0Interface;
