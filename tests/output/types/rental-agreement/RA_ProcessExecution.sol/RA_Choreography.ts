...
export interface RA_ChoreographyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface RA_Choreography extends BaseContract {
  connect(runner?: ContractRunner | null): RA_Choreography;
  waitForDeployment(): Promise<this>;

  interface: RA_ChoreographyInterface;
