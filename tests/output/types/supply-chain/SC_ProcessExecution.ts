...
export interface SC_ProcessExecutionInterface extends Interface {
  getFunction(
...
export interface SC_ProcessExecution extends BaseContract {
  connect(runner?: ContractRunner | null): SC_ProcessExecution;
  waitForDeployment(): Promise<this>;

  interface: SC_ProcessExecutionInterface;
