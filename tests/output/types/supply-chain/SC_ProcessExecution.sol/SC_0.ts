...
export interface SC_0Interface extends Interface {
  getFunction(
...
export interface SC_0 extends BaseContract {
  connect(runner?: ContractRunner | null): SC_0;
  waitForDeployment(): Promise<this>;

  interface: SC_0Interface;
