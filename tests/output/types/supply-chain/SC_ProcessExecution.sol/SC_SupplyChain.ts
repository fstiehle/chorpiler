...
export interface SC_SupplyChainInterface extends Interface {
  getFunction(
...
export interface SC_SupplyChain extends BaseContract {
  connect(runner?: ContractRunner | null): SC_SupplyChain;
  waitForDeployment(): Promise<this>;

  interface: SC_SupplyChainInterface;
