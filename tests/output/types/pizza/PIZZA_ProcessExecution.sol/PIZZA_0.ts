...
export interface PIZZA_0Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "enact"
      | "items"
...
export interface PIZZA_0 extends BaseContract {
  connect(runner?: ContractRunner | null): PIZZA_0;
  waitForDeployment(): Promise<this>;

  interface: PIZZA_0Interface;
